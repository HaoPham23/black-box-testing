...
\begin{table}[H]
    ...
    Trần Mậu Thật & Phạm Đức Hào & Message Forum \& Edit Score&20\%\\ \hline
    \end{longtable}
...
\input{content/descriptions/hao.tex}

\input{content/descriptions/nhan.tex}

\input{content/descriptions/ducquan.tex}

\input{content/descriptions/minhquan.tex}

\input{content/descriptions/that.tex}
\section{Results}

\input{content/results/hao.tex}

\input{content/results/nhan.tex}

\input{content/results/ducquan.tex}

\input{content/results/minhquan.tex}

\input{content/results/that.tex}
\end{document}
