...
\begin{table}[H]
    ...
    \begin{tabular}{|l|p{11cm}|}
        ...
        & 4. Người dụng chọn thông tin ngày, tháng, năm, giờ, phút của sự kiện. \\
        & 5. Người dùng nhấn vào nút "Luư". \\
        & 6. Hệ thống đóng bảng "Sự kiện mới". \\
        \hline
        Alternative flows & A1. Tại bước 5: \\
        & 5.1. Người dùng nhấn vào nút "Show more". \\
        & 5.2. Người dùng nhập thông tin vào ô "Mô tả". \\
        & Quay lại bước 5 trên Normal flow. \\
        & \\
        & A2. Tại bước 5: \\
        & 5.1. Người dùng nhấn vào nút "Show more". \\
        & 5.2. Người dùng nhập thông tin vào ô "Địa chỉ". \\
        & Quay lại bước 5 trên Normal flow. \\
        & \\
        & A3. Tại bước 5: \\
        & 5.1. Người dùng nhấn vào nút "Show more". \\
        & 5.2. Người dùng chọn lựa chọn "Tới" tại hàng "Thời lượng". \\
        & 5.3. Người dụng chọn thông tin ngày, tháng, năm, giờ, phút kết thúc của sự kiện. \\
        & Quay lại bước 4 trên Normal flow. \\
        & \\
        & A4. Tại bước 5: \\
        & 5.1. Người dùng nhấn vào nút "Show more". \\
        & 5.2. Người dùng chọn lựa chọn "Thời lượng tính bằng phút" tại hàng "Thời lượng". \\
        & 5.3. Người dụng nhập thông tin vào ô dưới "Thời lượng tính bằng phút". \\
        & Quay lại bước 5 trên Normal flow. \\
        & \\
        & A5. Tại bước 5: \\
        & 5.1. Người dùng nhấn vào nút "Show more". \\
        & 5.2. Người dùng chọn vào ô "Lặp lại sự kiện này". \\
        & 5.3. Người dùng nhập thông tin vào ô "Lặp lại hàng tuần, tạo ra tất cả". \\
        & Quay lại bước 5 trên Normal flow. \\
        \hline
        Exception flows & \\
        & E1. Tại bước 3: \\
        ...
        & 5.1. Người dùng nhấn vào nút "Show more". \\
        & 5.2. Người dùng chọn lựa chọn "Thời lượng tính bằng phút" tại hàng "Thời lượng". \\
        & 5.3. Người dụng nhập thông tin không phải số nguyên dương vào ô dưới "Thời lượng tính bằng phút". \\
        & 5.4. Người dùng nhấn nút "Lưu". \\
        & 5.5. Hệ thống báo lỗi "Khoảng thời gian tính bằng phút mà bạn vừa nhập không có hiệu lực. Vui lòng nhập một khoảng thời gian tính bằng phút lớn hơn 0 hoặc không chọn thời gian.". \\
        & Quay lại bước 5.2 trên Exception flow E2. \\
        \hline
    \end{tabular}
